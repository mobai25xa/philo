...
impl ProviderConfigSnapshot {
    ...
    pub(super) fn provider_id_field(&self) -> &ResolvedField<String> {
        &self.provider_id
    }

    pub(super) fn protocol_id_field(&self) -> &ResolvedField<String> {
        &self.protocol_id
    }

    pub(super) fn endpoint_field(&self) -> &ResolvedField<EndpointSpec> {
        &self.endpoint
    }

    pub(super) fn audience_field(&self) -> &ResolvedField<CredentialAudienceSpec> {
        &self.credential_audience
    }

    pub(super) fn credential_field(&self) -> &ResolvedField<SecretReference> {
        &self.credential
    }

    pub(super) fn identity_field(&self) -> &ResolvedField<ClientIdentityConfig> {
        &self.client_identity
    }

    pub(super) fn error_limit_field(&self) -> &ResolvedField<usize> {
        &self.max_http_error_body_bytes
    }
}
