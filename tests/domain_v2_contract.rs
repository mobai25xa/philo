//! Phase-two domain and exact-model capability contract tests.
...
#[test]
fn p2_capability_defaults_are_unknown_without_changing_p1_defaults() {
...
#[test]
fn exact_model_profile_overrides_only_p2_model_capabilities() {
    ...
    let test_runtime = philo::provider::TestOnlyProfile::localhost(
